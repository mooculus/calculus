...
%\node at (axis cs:2,1.8) [penColor] {\footnotesize $(x,2), x<3$};
	...
	\addplot [draw=penColor,very thick, smooth,->] coordinates {(2.8,1.2)(3.7,1.2)};
	\addplot [draw=penColor,very thick, smooth,->] coordinates {(4.8,1.2)(3.9,1.2)};
	\addplot [draw=penColor,very thick, smooth,->] coordinates {(3.8,2.2)(3.8,1.3)};
	\addplot [draw=penColor,very thick, smooth,->] coordinates {(3.8,0.2)(3.8,1.1)};
