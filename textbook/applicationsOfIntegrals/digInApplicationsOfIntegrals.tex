...
The displacement of the particle from $t=0$ to $t=\pi$ is  $ \int_0^\pi \sin(t) \d t = \answer[given]{2}$ 

The displacement of the particle from $t=0$ to $t=2\pi$ is $\int_0^{2\pi} \sin(t) \d t = \answer[given]{0}$

The distance traveled by the particle from $t=0$ to $t=\pi$ is $\int_0^\pi  \left| \sin(t) \right|  \d t = \answer[given]{2}$

The distance traveled by the particle from $t=0$ to $t=2\pi$ is $\int_0^{2\pi}  \left| \sin(t) \right|  \d t = \answer[given]{4}$
...
A graph of $\sin x$ is sketched along with a rectangle
with height $\sin (0.69)$ are pictured below . The area of the rectangle is the same as
