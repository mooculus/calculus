...
\section{The Power of the Pythagorean identity}
...
\end{tikzpicture}
    ...
    \]
    If we divide this expression by $\answer[given]{\cos^2\theta}$ we obtain
    \[
    1 + \tan^2\theta = \sec^2\theta
    \]
    and if we divide $\cos^2\theta + \sin^2\theta = 1$ by $\answer[given]{\sin^2\theta}$ we obtain
    \[
