...
\choice[correct]{A sequence of remainders can be defined for $\sum_{k=1}^{\infty} a_k$.}
\choice[correct]{A sequence of remainders can be defined for $\sum_{k=1}^{\infty} s_k$.}
\end{selectAll}
