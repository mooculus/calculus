...
\begin{description}
\item[\dfn{Constant function}] $f(x) =k$ is continuous on $-\infty < x < \infty$.
\item[\dfn{Identity function}] $f(x) = x$ is continuous on $-\infty < x < \infty$.
\item[\dfn{Power function}] $f(x)=x^b$ is continuous on $-\infty < x < \infty$.
\item[\dfn{Exponential function}] $f(x)=b^x$ is continuous on $-\infty < x < \infty$.
\item[\dfn{Logarithmic function}] $f(x)=\log_b(x)$ is continuous on $0 < x < \infty$.
