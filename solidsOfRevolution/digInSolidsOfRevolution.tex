...
Some volumes of revolution are difficult to set up using the Washer Method.  For instance, consider the solid formed when the region $R$ bounded by the curves $y=0$ and $y=\sin(3x)$ from $x=0$ to $x=\frac{\pi}{3}$ is revolved about the $y$-axis:
