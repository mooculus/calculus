...
\[
\frac{\cos(\theta)\sin(\theta)}{2} \le \left(\frac{\theta}{2\pi}\right)\cdot\pi \le \frac{\tan(\theta)}{2}.
\]
...
\]
Dividing through by $\sin(\theta)$ and taking the reciprocals, we find
\[
...
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot [very thick, penColor2, smooth, domain=(-.2:.2+pi/2)] ({cos(deg(x))},{sin(deg(x))}); %% Circle
          \addplot [textColor] plot coordinates {(0,0) (.766,.643)}; %% diagonal line at 40 degrees
          \addplot [textColor] plot coordinates {(1,.643) (.766,.643)}; %% top of rect
          \addplot [very thick, penColor] plot coordinates {(.766,0) (.766,.643)}; %% left hand side of triangle
          \addplot [textColor] plot coordinates {(1,0) (1,.643)}; %% right hand side of rect
          \addplot [line cap=round,line join=round,very thick,penColor,fill=fill1] plot coordinates {(.766,.643) (1,0)}\closedcycle; %% triangle
          \addplot [textColor,smooth, domain=(0:40)] ({.15*cos(x)},{.15*sin(x)});
          \node at (axis cs:.15,.07) [anchor=west] {$\theta$};
          \node at (axis cs:.766,.322) [anchor=east] {$\sin(\theta)$};
          \node at (axis cs:.9,.643) [anchor=south] {$1-\cos(\theta)$};
        \end{axis}
\end{tikzpicture} & 
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot [draw=none, fill=fill1, samples=100, domain=(0:40)] ({cos(x)},{sin(x)})\closedcycle; %% sector 
          \addplot [textColor] plot coordinates {(0,0) (.766,.643)}; %% diagonal line at 40 degrees
          \addplot [textColor] plot coordinates {(1,0) (.766,.643)}; %% diagonal line at 40 degrees
          \addplot [textColor] plot coordinates {(1,.643) (.766,.643)}; %% top of rect
          \addplot [very thick, penColor] plot coordinates {(.766,0) (.766,.643)}; %% left hand side of triangle
          \addplot [textColor] plot coordinates {(1,0) (1,.643)}; %% right hand side of rect
          \addplot [very thick, penColor, smooth, domain=(0:40)] ({cos(x)},{sin(x)});
          \addplot [very thick, penColor] plot coordinates {(.766,0) (1,0)};
          \addplot [textColor,smooth, domain=(0:40)] ({.15*cos(x)},{.15*sin(x)});
          \node at (axis cs:.15,.07) [anchor=west] {$\theta$};
          \node at (axis cs:.766,.322) [anchor=east] {$\sin(\theta)$};
          \node at (axis cs:.9,.643) [anchor=south] {$1-\cos(\theta)$};
          \node at (axis cs:.5,0) [anchor=north] {$\cos(\theta)$};
        \end{axis}
\end{tikzpicture} & 
\begin{tikzpicture}
	\begin{axis}[clip=false,
          ...
          \addplot [very thick,penColor,fill=fill1] plot coordinates {(.766,.643) (1,.643)}\closedcycle; %% rectangle fill
          \addplot [very thick, penColor2, smooth, domain=(-.1:1.671)] ({cos(deg(x))},{sin(deg(x))});
          \addplot [textColor] plot coordinates {(1,0) (.766,.643)}; %% diagonal line at 40 degrees
          \addplot [very thick, penColor] plot coordinates {(.766,.643) (1,.643)}; %% top of rectangle
          \addplot [textColor] plot coordinates {(.766,0) (.766,.643)}; %% 40 degrees
          \addplot [textColor] plot coordinates {(0,0) (.766,.643)}; %% 40 degrees triangle
          \addplot [textColor,smooth, domain=(0:40)] ({.15*cos(x)},{.15*sin(x)});
          \node at (axis cs:.15,.07) [anchor=west] {$\theta$};
          \node at (axis cs:.9,.643) [anchor=south] {$1-\cos(\theta)$};
          \node at (axis cs:.766,.322) [anchor=east] {$\sin(\theta)$};          
        \end{axis}
\end{tikzpicture}\\
Triangle & Region & Rectangle \\
\end{tabular}


From our diagrams above we see that
\[
\text{Area of Triangle} \le \text{Area of Region} \le \text{Area of Rectangle}
\]
and computing these areas we find
\[
\frac{\sin(\theta)(1-\cos(\theta)}{2} \le
\left(\frac{\theta}{2\pi}\right)\cdot\pi - \frac{\sin(\theta)\cos(\theta)}{2}\le 
\sin(\theta)(1-\cos(\theta).
\]
Multiplying through by $2$, and recalling that $\tan(\theta) =
\frac{\sin(\theta)}{\cos(\theta)}$ we obtain
