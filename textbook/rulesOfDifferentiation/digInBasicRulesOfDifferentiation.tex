...
have a nice rule.  To gain intuition, you should compute the
derivative of $f(x) = x^3$ using the limit definition of the
derivative. Before we do this, we need to recall the \dfn{Binomial
  Theorem}\index{Binomial Theorem}. This states that if $n$ is a
...
\]
The binomial theorem tells us the pattern of the coefficients for the expanded form of
\[
(a+b)^n.
\]
Knowing this helps prove the next theorem.
