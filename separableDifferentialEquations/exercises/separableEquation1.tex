...
Using the properties of logarithms: $e^{-5 \ln|x|} = e^{\ln \left(|x|^{-5}\right) = |x|^{-5} = $
\[
4-5y = Cx
\]

We can now use the initial condition $y(1) = 2$ to find $C = \answer{-6}$, so the specific solution is:
