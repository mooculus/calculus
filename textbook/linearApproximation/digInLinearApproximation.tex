...
0$, we will set $x = 0$ and $\d x=0.3$. Write with me
\begin{align*}
  \sin(0.3) = f(x + \d x) &\approx  f(x) + \d f\\
  &\approx 0 + \d f.
  \end{align*}
