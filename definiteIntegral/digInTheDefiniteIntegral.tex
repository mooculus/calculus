...
\begin{definition}[Net Area]\index{Net Area}
	This sum of signed areas is called the \dfn{net area} of the region  between the graph of $f$ and the interval on the $x$- axis .
\end{definition}
