...
\begin{example}
  Consider $f(x) = \lfloor x\rfloor$. For your convienence, we give a
  graph:
\begin{image}
\begin{tikzpicture}
	\begin{axis}[
...
Consider again the greatest integer function
\[
f(x) \lfloor x\rfloor
\]
\begin{image}
...
ADD PICT FROM MOOCULUS/SEE CALC PRELECT
