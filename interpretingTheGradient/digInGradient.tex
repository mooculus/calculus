...
There are three things you must know about the gradient.

\paragraph{How to compute the gradient vector.}

\paragraph{The gradient vector points in the inital direction of greatest increase of the function.}

\paragraph{The gradient vector is orthogonal to level sets.}
