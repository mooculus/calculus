...
\begin{image}  
  \begin{tikzpicture}  
    \begin{axis}[  
      ...
      \addplot[data cs=polar,blue,domain=0:360,samples=360,smooth, thick] (x,{1+2*cos(x)});
...
\begin{image}  
  \begin{tikzpicture}  
    \begin{axis}[  
      ...
      \addplot[data cs=polar,blue,domain=0:360,samples=360,smooth, thick] (x,{2*cos(3*x)});
