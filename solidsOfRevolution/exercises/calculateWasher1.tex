...
The region $R$ bounded by $y=\sin(x)$, $y=\cos(x)$, $x=-\frac{\pi}{4}$ and $x=-\frac{3\pi}{4}$. is shown below:
...
\begin{exercise}
Evaluating the integral gives that the volume of the solid of revolution is $\answer{4 \sqrt{2}}$ cubic units.
\end{exercise}
\end{exercise}
\end{exercise}
\end{document}