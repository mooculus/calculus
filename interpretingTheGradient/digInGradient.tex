...
\begin{example}
  ...
  \begin{explanation}
    ...
    is some scalar function $c(t)$ such that
    \[
    c(t)\grad F(x(t),y(t)) = \vec{w}'(t) = \vector{x'(t), y'(t)}.
    \]
    ...
    Then
    \begin{align*}
      c(t)\cdot \grad F(x(t),y(t)) &= \vector{ x'(t), y'(t)}\\
      c(t)\cdot \vector{-2x(t),-4y(t)} &= \vector{ x'(t), y'(t)}\\
      \vector{-2c(t)x(t),-4c(t)y(t)} &= \vector{ x'(t), y'(t)}\\
          \end{align*}
    This implies
    \[
    -2c(t)x(t) = x'(t) \quad \text{and} \quad  -4c(t)y(t) =y'(t)
    \]
    so
    \[
    c(t) = -\frac{x'(t)}{2x(t)} \quad \text{and} \quad  c(t) =-\frac{y'(t)}{4y(t)}.
    \]
