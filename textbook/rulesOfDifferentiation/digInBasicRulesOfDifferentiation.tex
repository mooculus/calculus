...
derivative. Before we do this, we need to recall the \textit{Binomial
  Theorem}.
...
(a+b)^n.
\]
Knowing this helps us prove our next derivative rule.
...
We will now work some basic examples. 
