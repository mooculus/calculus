...
The range of $f$ (from bottom to top) is:
 ...
 $\left[\answer{-4},\answer{-2}\right] \cup \left\{\answer{-1}\right\} \cup \left(\answer{0},\answer{2}\right) \cup \left(\answer{2},\answer{6}\right]$.

Find the following limits, if they exist.  If a limit does not exist, write DNE and explain why.
...
\choice{The limit DNE because $f(0)$ does not exist.}
\choice{The limit DNE because $f(0)$ is not close to the values of $f$ near 0.}
\choice{The limit DNE because $\lim_{x\to0^-}f(x)\neq\lim_{x\to0^+}f(x)$.}
\end{multipleChoice}
...
\begin{multipleChoice}
\choice[correct]{The limit does exist.}
\choice{The limit DNE because $f(3)$ does not exist.}
\choice{The limit DNE because $f(3)$ is not close to the values of $f$ near 3.}
\choice{The limit DNE because $\lim_{x\to3^-}f(x)\neq\lim_{x\to3^+}f(x)$.}
\end{multipleChoice}
...
\choice{The limit DNE because $f(3)$ does not exist.}
\choice{The limit DNE because $f(3)$ is not close to the values of $f$ near 3.}
\choice[correct]{The limit DNE because $\lim_{x\to3^-}f(x)\neq\lim_{x\to3^+}f(x)$.}
\end{multipleChoice}

Find the following values.
\begin{hint}

Recall:  The statement ``$f^{-1}(-2)=a$"  is equivalent to the statement
