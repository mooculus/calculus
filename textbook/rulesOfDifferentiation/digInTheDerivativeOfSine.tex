...
\begin{question}
  Using Theorem \ref{theorem:deriv sin}, what is the slope of the line tangent to $\sin(x)$ at $x = \pi/4$?
  
  \[
  \ddx(\sin(x)) \eval{x = \pi/4} = \answer[given]{\sqrt{2}/2}
  \]
\end{question}
...
\begin{question}
 ...
 The function $\sin(x)$ has slope $-1$ at $x = \answer[given]{\pi}$.
\end{question}
