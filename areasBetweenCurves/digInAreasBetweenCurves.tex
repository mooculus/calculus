...
We cannot determine the exact area of the slice, but we can approximate each slice by a rectangle whose heights are determined by the value of the function $y = f(x)$ at some $x$-value on the base of the rectangle.  Here, we use the right-hand endpoint to determine the height of each rectangle.
