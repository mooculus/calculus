...
\[
0\le \sin{\left(\frac{1}{x}\right)}\le 1
\]

by multiplying these inequalities by $\sqrt[5]{x} \ge0$
, we obtain
\[
0\le \sqrt[5]{x}\sin{\left(\frac{1}{x}\right)} \le \sqrt[5]{x}
\]
which can be written as


\[
0\le f(x) \le \sqrt[5]{x}
\]
and, therefore as
...
Since
\[
-1\le \sin{\left(\frac{1}{x}\right)}\le 0
\]
...
Since 
\[
\lim_{x\to 0}0= \answer[given]{0} = \lim_{x\to 0}\Big|\sqrt[5]{x}\Big|
\]
