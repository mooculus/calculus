...
The figure below shows the graph of $f$, where $f(x)=-x^2$ and the point $P(0,3)$.  Find the equations of all tangent lines to the curve $y=f(x)$ that pass through the point $P$.
