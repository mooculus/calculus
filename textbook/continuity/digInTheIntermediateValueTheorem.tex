...
The Intermediate Value Theorem can be use to show curves cross:
...
\begin{example} 
  ...
  \begin{align*}
    h(1) &= f(1) - g(1) \\
    &= \answer[given]{1}^2\ln(\answer[given]{1}) - 2\cdot\answer[given]{1}\cos(\ln(\answer[given]{1}))\\
    &= \answer[given]{-2}.
  \end{align*}
  and in a similar fashion
   \begin{align*}
    h(e) &= f(e) - g(e) \\
    &= e^2\answer[given]{1} - 2\cdot e\cos(\answer[given]{1})
   \end{align*}
