...
\begin{exercise}
  ...
  \choice{$\R$}
  \choice{$\R^2$}
  \choice{$\left\{(x,y) \in \R^2 : 2x-y+1 >0 \right\}$}
    \choice{$\left\{(x,y) \in \R^2 : 2x-y+1 >0 \right\}$}
  \choice[correct]{$\left\{(x,y) \in \R^2 : 2x-y+1 >0, (x,y) \neq (0,0) \right\}$}
    \choice{$\left\{(x,y) \in \R^2 : 2x-y+1 \geq 0 \right\}$}
  \choice{$\left\{(x,y) \in \R^2 : 2x-y+1 \geq 0, (x,y) \neq (0,0) \right\}$}
  \end{multipleChoice}
