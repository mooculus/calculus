...
\begin{question}
	...
	\feedback{Did you notice how these two expressions had all the same terms?  Both are just shorthands for the sum $2+3+4+5+6$.  This is called ``reindexing'' a sum.}
\end{question}
...
\begin{question}
	If $\sum_{k=1}^{k=n} f(k) = n^2$, then $f(j) = \answer{2j-1}$
		...
		\end{hint}
	\feedback{This is kind of cool.  It says that the sum of the first $n$ odd number is $n^2$.  Test it and see!  Can you find a geometric interpretation of this?  If you are interested by this, talk to your TA!}
\end{question}
