...
\begin{image}
  ...
  \begin{axis}[
    ...
    \addplot [draw=none, fill=fillp,domain=1:5.2 ] {1/x} \closedcycle;
...
\begin{image}
  ...
  \begin{axis}[
    ...
    \addplot [draw=none, fill=fillp,domain=1:3.2 ] {1/x^2} \closedcycle;
...
\begin{image}
  ...
  \begin{axis}[
    ...
    \addplot [draw=none, fill=fillp, domain=.25:1] {1/sqrt(x)} \closedcycle;
