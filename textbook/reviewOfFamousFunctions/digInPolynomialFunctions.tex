...
Note how in the graph above, the function starts with negative values
and ends with postivive values.


On the other hand, when the lead coefficient is negative, the graph
looks something like the graph given below.
...
Note how in the graph above, the function starts with positiv we values
and ends with negative values.
