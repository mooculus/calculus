...
\choice{$ \lim_{a \rightarrow 0^+} \int \dfrac{17x-12}{(3x+4)(x^2+4)} \d x$}
\choice[correct]{$\lim_{b\rightarrow \infty} \int_{\answer{0}}^{\answer{b}} \int \dfrac{17x-12}{(3x+4)(x^2+4)} \d x $}
\end{multipleChoice}
