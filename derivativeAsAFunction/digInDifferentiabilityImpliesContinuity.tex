...
\begin{question}
What does the graph of a function $f$ look like when $f$ is not differentiable at $a$?
\begin{explanation}
...
Each of the figures A-D depicts a function that is not differentiable at $a=1$. 
 \begin{image}
    \begin{tabular}{cc}
	  ...
	  \addplot [very thick, penColor, smooth,domain=(-2:0.95)] {x};
	   \addplot [very thick, penColor, smooth,domain=(1:2)] {0.5};
	  ...
	  \addplot [very thick, penColor, smooth,domain=(1:2)] {2-x};
	  ...
	  \addplot [ very thick, penColor, smooth,domain=(1:2)] {(x-1)^(1/2)};
	    \addplot [very thick, penColor, smooth,domain=(-2:1)] {-(1-x)^(1/2)};
