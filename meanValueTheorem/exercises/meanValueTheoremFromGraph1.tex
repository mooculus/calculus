...
\end{exercise}
  \begin{exercise}
  Complete the statement. Select all correct choices. Note, $m$ is the slope of the secant line through the points $(0,f(0))$ and $(4,f(4))$.
  
  The Mean value theorem guarantees that there exists a point $c$ in the open interval $(0,4)$ such that the slope of the tangent line to the curve $y=f(x)$ at the point $x=c$ is 
  \begin{selectAll}
\choice{$f'(c)=4$}
\choice{$f(c)=4$}
\choice{$f(c)=m$}
