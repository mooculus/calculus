...
\paragraph{Step 1: Slice} Since the cross-sections are perpendicular to the $x$-axis, this means: \wordChoice{\choice{the slices are horizontal.}\choice[correct]{the slices are vertical.}} 
