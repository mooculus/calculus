...
\begin{problem}
  Suppose $x$ is close to $0$ and $y$ is close to $-2$.  What can be said about $xy$?
  \begin{multipleChoice}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    ...
    \choice{The quantity $1/x^2$ can be made as large as desired.}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  $f(\sin 0.03) = 6$.  What is a good guess for $\sin f(0.01)$?
  \begin{multipleChoice}
    \choice[correct]{$2$}
    \choice{$4$}
    \choice{$6$}
...
\begin{problem}
  Suppose $f(0) = 0$ and $f'(0) = 1$.  Which is the larger quantity?
  \begin{multipleChoice}
...
\begin{problem}
  Suppose $f(0) = 0$ and $f'(0) = 1$. If $h$ is a very small but positive number, which is likely to be larger?
  \begin{multipleChoice}
