...
\]
This estimate is an \wordChoice{\choice[correct]{underestimate}\choice{overestimate}} because the second derivative of $f$ is \wordChoice{\choice{negative}\choice[correct]{positive}} on the interval $\left( \answer{4}, \answer{4.01} \right)$.
