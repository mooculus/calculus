...
(b) Assume that $P(t)$ is continuous on $[0,+\infty)$ and differentiable on $(0,+\infty)$. Is there a moment in which the instantaneous rate of change of $P$ is equal to the average rate of change computed in part (a)? \begin{multipleChoice}\choice[correct]{Yes}\choice{No}\end{multipleChoice}, by the \begin{multipleChoice}\choice{Intermediate Value Theorem}\choice[correct]{Mean Value Theorem}\choice{L`Hospital's Rule}\end{multipleChoice}
...
%Exercise 25
\begin{exercise}
Consider an object moving along a line.  The grapoh of the velocity, $v$, of the object is shown in the figure below.
