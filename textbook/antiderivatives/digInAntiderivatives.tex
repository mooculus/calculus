...
%	\end{question}
	...
	\end{free-response}
	\feedback{This is an example of what is called a \textit{characterization theorem} in mathematics.  We found that $\sin$ and $\cos$ could be \textit{characterized} (totally ``pinned down'') as solutions to these differential equations. } 
	\end{question}
