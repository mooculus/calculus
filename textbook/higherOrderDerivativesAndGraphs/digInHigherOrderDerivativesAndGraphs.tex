...
\begin{example}
  ...
  \begin{explanation} %%BADBAD Need Dropdown
    ...
    increasing when $B$ is positive and decreasing when $B$ is
    negative, we see
    \[
    A'=B.
    \]
    Since $B$ is increasing when $C$ is positive and decreasing when
    $C$ is negative, we see
    \[
    B'=C.
    \]
...
\end{image}
    Identify each curve above as a graph of $f$, $f'$, or $f''$.
      \begin{explanation} %%BADBAD Need Dropdown
        ...
        increasing when $A$ is positive and decreasing when $A$ is
        negative, we see
        \[
        B'=A.
        \]
...
\begin{example}
  ...
  %what strategies you could use to identify which graph corresponds
    ...
    C'=B.
    \]
    Since $B$ is increasing when $A$ is positive and decreasing when
    $A$ is negative, we see
    \[
    B'=A.
    \]
    Hence $f=A$, $f'=B$, and $f''=C$.
