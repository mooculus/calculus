...
$\vec{v}$ and $\vec{w}$ are in the plane. Given a vector-valued surface $\vec{P}(s,t)$, 
...
TABLE OF VALUES APPROXIMATE

z = F(x,y), give a vector-valued formula for surface, find tangent
plane using vector-valued methods, then confirm same plane as other
methods.
...
\begin{example}
  ...
  \begin{explanation}
   ...
   For part \ref{eg:tpc}, we would like a parametric description $\vec{q}(t)$ of the line $y = 
          ...
          \[
          \vec{q}(t) = \vector{\answer[given]{t}, \answer[given]{3t-1}}.
          \]
          ...
          already have a parametric description $\vec{q}(t) =
          \vector{x(t), y(t)}$, we plug these coordinates in for $x$
          and $y$ to find our $z$- coordinate.  We find
          \[
          \vec{p}(t) = F\left( \vec{p}(t) \right ) = \vector{\answer[given]{t}, \answer[given]{3t-1}, \answer[given]{10t^2-3t+4}}
          \]
