...
\begin{example}
  ...
  \begin{tikzpicture}[
	...
	\begin{axis}[
          ...
          \node[anchor=west] at (axis cs:2,6) {${\color{penColor}v(0)\cdot 2}$};
...
\end{image}
  ...
  \begin{tikzpicture}[
	...
	\begin{axis}[
          ...
          \node[anchor=west] at (axis cs:4,18) {${\color{penColor2}v(2)\cdot 2}$};
...
\end{image}
  ...
  \begin{tikzpicture}[
	...
	\begin{axis}[
          ...
          \node[anchor=west] at (axis cs:6,27) {${\color{penColor3}v(4) \cdot 2}$};
...
\end{tikzpicture}
  ...
  \begin{tikzpicture}[
	...
	\begin{axis}[
          ...
          \node[anchor=east] at (axis cs:8,30) {${\color{penColor4}v(6)\cdot 2}$};
...
\end{image}
  ...
  \begin{tikzpicture}[
	...
	\begin{axis}[
          ...
          \node[anchor=east] at (axis cs:10,26) {${\color{penColor5}v(8)\cdot 2}$};  
