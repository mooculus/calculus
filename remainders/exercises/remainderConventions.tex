...
\begin{itemize}
\item It is always possible to define a sequence of remainders for $\sum_{k=n_0}^{\infty} a_k$ \wordChoice{\choice[correct]{$\sum_{k=n_0}^{\infty} a_k$ converges}\choice{we have a formula for the terms in the sequence of partial sums}\choice{whether $\sum_{k=n_0}^{\infty} a_k$ converges or diverges}} . 
