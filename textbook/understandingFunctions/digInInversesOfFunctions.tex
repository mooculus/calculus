...
\begin{example}
  ...
  \begin{explanation}
    If $f$ converts Celsius measurements into Fahrenheit measurements of
...
Look again at the last question.  If two different inputs for a function have the same output, there is no hope  of that function having an inverse function.  Why?  The inverse function must also be a function, and a function can only have one output for each input.  More specifically, we have the next definition.
