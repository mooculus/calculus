...
expanding at a point. To be more explicit, the divergence measures how
the magnitude of the field vectors change as you move in the direction
  ...
  \begin{tikzpicture}%[framed]
    \begin{axis}[
      ...
      \pgfplotsinvokeforeach{1,2,...,13}{
        \addplot[penColor,thick,->] coordinates{ (1,#1) (2,#1) };
        \addplot[penColor,thick,->] coordinates{ (3,#1) (5,#1) };
        \addplot[penColor,thick,->] coordinates{ (6,#1) (9,#1) };
        \addplot[penColor,thick,->] coordinates{ (10,#1) (14,#1) };
      }
       
       \node[inner sep=0pt,text width=7cm,scale=.9] at (axis cs: 7.5,-3)
            {\footnotesize Since the magnitude of the field vectors
              \textbf{increases} as we move in the direction of the
              field, the divergence is positive.};
...
\begin{image}
  \begin{tikzpicture}%[framed]
    \begin{axis}[
      ...
      \pgfplotsinvokeforeach{1,2,...,13}{
        \addplot[penColor,thick,->] coordinates{ (1,#1) (5,#1) };
        \addplot[penColor,thick,->] coordinates{ (6,#1) (9,#1) };
        \addplot[penColor,thick,->] coordinates{ (10,#1) (12,#1) };
        \addplot[penColor,thick,->] coordinates{ (13,#1) (14,#1) };
      }
       
       \node[inner sep=0pt,text width=7cm,scale=.9] at (axis cs: 7.5,-3)
            {\footnotesize Since the magnitude of the field vectors
              \textbf{decreases} as we move in the direction of the
              field, the divergence is negative.};
...
\begin{question}
  Suppose that the divergence of a vector field $\vec{F}:\R^2\to\R^2$ is
