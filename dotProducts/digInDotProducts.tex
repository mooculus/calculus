...
\begin{definition}
  Two nonzero vectors are called \dfn{orthogonal} if the the dot
  product of these vectors is zero. Geometrically, this means that the
  angle between the vectors is $\pi/2$ or $90^\circ$.
\end{definition}
