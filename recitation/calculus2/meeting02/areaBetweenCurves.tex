...
\begin{problem}
A student is asked to compute the area of the region bounded by the curves $y=\sin (x)$, $y = 0$, $x=0$ and $x=2\pi$. The student responds that the area is zero. Either explain why the student's answer is correct or explain a likely error in the student's reasoning and give the correct answer.
\begin{center}
\resizebox {6cm} {!} { 
          \begin{tikzpicture}
...
\item[II.] Find the area of the region bounded by the curves $y=e^{x}$, $y=e^{-x}+2$ and $x=0$. 

\item[III.] Find the area of the region bounded by the curves $x=y^2$ and $x=8-y^2$. The following figure may be useful.
