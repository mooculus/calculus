...
\outcome{Restrict domains to make different functions equal.}
%% This is not the ``reason'' for restricting domains.
...
\begin{problem}
  ...
  \choice{$\frac{x^2-3x+2}{x-2} = x-1$ for all $x$.}
  \choice{$\frac{x^2-3x+2}{x-2} \ne x-1$ for all $x$.}
  \choice{$\frac{x^2-3x+2}{x-2} = x-1$ when $x\ne 2$.}
  %%BADBAD
