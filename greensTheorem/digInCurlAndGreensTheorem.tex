...
If the scalar curl is zero, then the field is a gradient field and you
should use the Fundamental theorem of line integrals. If the scalar
curl is ``simple'' and $R$ is easy to deal with, then use Green's
Theorem. If the scalar curl isn't simple, but you have a nice
parameterization for the boundary of $R$, then perhaps you should
