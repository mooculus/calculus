...
\begin{question}
  ...
  \begin{selectAll}
    ...
    \choice[correct]{Relating the social security number of living
      people to actual living people.}
    \choice[correct]{Relating people who have mothers to their mother.}
...
Moreover, whenever we talk about functions, we should explicitly state
...
\end{image}
Some might be confused because here we have multiple inputs that give
the same output. However, this is not a problem. To be a function, we
...
\[
f(x)=x-2\qquad\text{when}\qquad \text{when $x \ne 2$}.
\]
