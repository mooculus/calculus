...
\begin{exercise}
There's a much more efficient way to estimate using the integral test.  Note that since the terms in the series are all positive, this estimate is must be an \wordChoice{\choice{overestimate}\choice[correct]{underestimate}}.  Had we used $N=32$ and repeat the construction in the previous part to find new error bounds for the actual value of the series, which gives us a much better idea of the value of the series!
