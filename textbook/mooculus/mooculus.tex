...
%\documentclass[7pt,numbers,handout,twocolumn]{xourse}
...
%% \usepackage[margin=.5in, includehead, includefoot, hmargin={.7in,.5in}, paperwidth=8.5in, paperheight=8.5in]{geometry}
...
%%%%%%%%%%%
\begin{prompt}
\activity{../derivativePractice/reinforceDerivativePractice.tex}
\end{prompt}
%%%%%%%%%%%
%%%%%%%%%%%
