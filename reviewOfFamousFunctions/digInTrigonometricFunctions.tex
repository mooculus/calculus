...
\begin{image}[2in]
  ...
  \end{tikzpicture}
\end{image}
the angle $\theta$ cannot be negative and cannot exceed $\frac{\pi}{2}$ radians.  That means to talk about trigonometric functions for \emph{other} angles, we need to be able
...
\begin{definition}\hfil
  ...
  \begin{itemize}
    \item $\arccos(x) = \theta$ means that $\cos(\theta) = x$ and
      that $\theta$ is in $[0, \pi]$. The domain of $\arccos(x)$ is $[-1, 1]$.
    \item $\arcsin(x) = \theta$ means that $\sin(\theta) = x$ and
      that $\theta$ is in $\left[-\dfrac{\pi}{2}, \dfrac{\pi}{2}\right]$. The domain of
      $\arcsin(x)$ is $[-1, 1]$.
    \item $\arctan(x) = \theta$ means that $\tan(\theta) = x$ and
      that $\theta$ is in $\left(-\dfrac{\pi}{2}, \dfrac{\pi}{2}\right)$. The domain of
      $\arctan(x)$ is $(-\infty, \infty)$.
    \item $\arccot(x) = \theta$ means that $\cot(\theta) = x$ and that 
      $\theta$ is in $(0, \pi)$. The domain of $\arccot(x)$ is
      $(-\infty, \infty)$.
    \item $\arcsec(x) = \theta$ means that $\sec(\theta) = x$ and
     that $\theta$ is in the interval $[0, \pi]$ except $\theta \neq \dfrac{\pi}{2}$, written in interval notation as $\left[0, \dfrac{\pi}{2}\right] \cup \left[\dfrac{\pi}{2}, \pi\right]$. 
     The domain of
      $\arcsec(x)$ is all $x$ with absolute value greater than $1$, written in interval notation as $(-\infty, -1] \cup [1, \infty)$.
    \item $\arccsc(x) = \theta$ means that $\csc(\theta) = x$ and
      that $\theta$ is in $\left[-\frac{\pi}{2}, 0\right] \cup \left[0, \frac{\pi}{2}\right]$. The
      domain of $\arccsc(x)$ is $(-\infty, -1] \cup [1, \infty)$.
  \end{itemize}
\end{definition}
