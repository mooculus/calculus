...
\item[Devyn] But was that crazy proof with all the triangles really
  ...
  \[
  \eval{\frac{\sin(\theta)}{\theta}}_{\theta=0} = \frac{\sin(0)}{0}=\dots
  \]
  \item[Riley] You were going to say $1$, right? 
  \item[Devyn] Yeah, but now I'm not sure I'm right.
  \item[Riley] I think dividing by zero is a bad thing.
  \item[Devyn] It is! I will never do it again. Also, don't tell
    anyone about this conversation.
  \item[Riley] What converasation?
  \item[Devyn] Exactly.
\end{dialogue}
