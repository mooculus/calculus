...
\]
Since this works in all dimensions, we will often use this to
construct our \textit{unit normal vector}. This normal vector will
always point toward the ``inside'' of how a curve is curving.
\begin{definition}
