...
%%     \shade[ball color=white!50!gray] plot[smooth] coordinates {(13.5,1.5) (14,3) (15,3.3)  (16.5,1.5)};
%%     \shade[top color=black!50!gray, middle color=black]  (15,1.5) ellipse (1.5 and .3);
%%     \draw[black,ultra thick] (15,1.5) ellipse (1.5 and .3);
%%     \node[black] at (15,0) {\scalebox{1}{$\displaystyle \iint_R (\curl \vec{F})\dotp\unormal \d S = \oint_{\partial R} \vec{F}\dotp \d \vec{p}$}};
%%   \end{tikzpicture}
%% \end{image}
