...
If you are more of a visual person, you should imagine a continuous function, where you know the value of the function at two endpoints,
$x=a$ and $x=b$, but you don't really know what the function does between the points $x=a$ and $x=b$:
\begin{image}
\begin{tikzpicture}
	\begin{axis}[
...
\end{image}
The Intermediate Value Theorem says that despite the fact that you don't really know what the function is doing between the endpoints, a
