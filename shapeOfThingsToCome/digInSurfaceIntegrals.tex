...
\begin{example}
  ...
  \begin{explanation}
    ...
    \begin{align*}
      \uvec{n}\d S &= \left(\pp[\vec{P}]{\answer[given]{s}}\cross\pp[\vec{P}]{\answer[given]{t}}\right)\d \answer[given]{t} \d \answer[given]{s}\\
      &=\left(
      \vector{\answer[given]{1},\answer[given]{-1},\answer[given]{1}}
      \cross
      \vector{\answer[given]{-1},\answer[given]{1},\answer[given]{2}}
      \right)\d \answer[given]{t} \d \answer[given]{s}\\
       &=
      \vector{\answer[given]{-3},\answer[given]{-3},\answer[given]{0}}
      \d \answer[given]{t} \d \answer[given]{s}.
    \end{align*}
    Now write:
    \[
    ...
    \begin{align*}
      \iint_R \vec{F}\dotp \uvec{n}\d S &=
      \int_{\answer[given]{0}}^{\answer[given]{1}}\int_{\answer[given]{1-s}}^{\answer[given]{1}} \left(\answer[given]{6s + 12 t}\right)\d \answer[given]{t} \d \answer[given]{s}\\
      &=
      \int_{\answer[given]{0}}^{\answer[given]{1}}\answer[given]{12s} \d \answer[given]{s}\\
      &=\answer[given]{6}.
    \end{align*}
  \end{explanation}
\end{example}
