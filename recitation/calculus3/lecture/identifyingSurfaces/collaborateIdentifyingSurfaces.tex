...
\begin{multicols}{2}
  ...
  \begin{enumerate}
  \item \raisebox{-.5\height}{\includegraphics[width=2in]{surfaceF}}
  \item \raisebox{-.5\height}{\includegraphics[width=2in]{surfaceB}}
  \item \raisebox{-.5\height}{\includegraphics[width=2in]{surfaceC}}
  \item \raisebox{-.5\height}{\includegraphics[width=2in]{surfaceA}}
  \item \raisebox{-.5\height}{\includegraphics[width=2in]{surfaceD}}
  \item \raisebox{-.5\height}{\includegraphics[width=2in]{surfaceE}}
  \end{enumerate}
\end{multicols}
\end{document}
