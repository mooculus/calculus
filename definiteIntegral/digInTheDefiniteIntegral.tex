...
\begin{align*}
  \sum_{k=1}^5 f(x_k^*)\Delta x= &\left(\underbrace{f(2)\Delta x}_{\text{nonnegative}}\\
  +  \underbrace{f(4)\Delta x}_{\text{nonnegative}}+  \underbrace{f(6)\Delta x}_{\text{nonnegative}}\right)+ \left(\underbrace{f(8)\Delta x}_{\text{negative}}+  \underbrace{f(10)\Delta x}_{\text{negative}}\right)
\end{align*}
 \end{example}
