  ...
  \begin{question}
    ...
    \begin{question}
      ...
      \begin{prompt}
        ...
        logarithm is an \wordChoice{\choice[correct]{larger}\choice{smaller}} 
        function of its input, meaning that as the input gets larger, the output  
        gets \wordChoice{\choice[correct]{larger}\choice{smaller}}.  In other words, 
        ...
        range $R$ is the interval $\left(\answer{-\infty},\answer{\ln(9)}\right]$.
      \end{prompt}
    \end{question}
  \end{question}
\end{question}
...
\hline
-0.5 & \answer[given]{-1} & \left(\answer[given]{-0.5},\answer[given]{1}\right) & \answer[given]{3.5} & \left(\answer[given]{-0.5}, \answer[given]{1},\answer[given]{3.5}\right)\\
...
0.5 & \answer[given]{1} & \left(\answer[given]{0.5}, \answer[given]{1}\right) &  \answer[given]{2.5}  & \left(\answer[given]{0.5}, \answer[given]{1}, \answer[given]{2.5}\right)\\
1 & \answer[given]{2} & \left(\answer[given]{1},\answer[given]{2}\right) & \answer[given]{2}          & \left(\answer[given]{1}, \answer[given]{2},   \answer[given]{2}\right)
\end{array}
\]
...
So far, we have focused mainly on the curve $\vec{p}(t)$ lying in the 
domain of a function $F$.  Let's now focus on the curve $F \left ( \vec{p} (t) \right )$ 
