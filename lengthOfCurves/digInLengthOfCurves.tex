...
\end{align*}
The exact length is thus $\answer[given]{\ln|\sec(3/2) + \tan(3/2)|-1}$ Using a calculator to find the length to 3 decimal places gives: $s = \answer[given,tolerance=.001]{3.341}$.
\end{explanation}
\end{model}
