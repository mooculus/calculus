...
\begin{example}
  ...
  \begin{explanation}
    ...
    \begin{align*}
      \dd{t} F(\vecl_{\mathrm{R}}(t)) &= \vector{\answer[given]{2(2t)},\answer[given]{-2(1-3)}}\dotp\vector{\answer[given]{2},\answer[given]{-3}}\\
      &=\answer[given]{6-10t}
    \end{align*}          
    We see that $t= \answer[given]{1/3}$ is the only critical point of
    $F(\vecl_{\mathrm{B}}(t))$. Evaluating this at its critical point
    ...
    \begin{align*}
      F(\vecl_{\mathrm{L}}(0)) &= \answer[given]{4}\\
      F(\vecl_{\mathrm{L}}(6/16)) &= \answer[given]{5.8}\\
      F(\vecl_{\mathrm{L}}(1))  &= \answer[given]{5}.
    \end{align*}
