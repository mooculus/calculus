...
Note:  the net area is the sum of the areas of the regions that lie above the $x-$axis minus the sum of  areas of regions that lie below the $x-$axis.
...
\begin{align*}
    ...
    &=\underbrace{A_2+A_4}_{\text{sum of areas above x-axis}}-\underbrace{(A_1+A_3)}_{\text{sum of areas below x-axis}}
\end{align*}
...
\]
Note: the last Riemann sum is clearly  the area of the region between the x-axis and the curve $y=-x$.
  ...
  \begin{tikzpicture}[
    ...
    %% yticklabels={},
       ...
       \addplot [draw=none,fill=fillp,domain=1:5, smooth] {f(x)} \closedcycle;
            \addplot [draw=none,fill=fillp,domain=5:8, smooth] {-f(x)} \closedcycle;
              \addplot [draw=none,fill=fillp,domain=8:9, smooth] {f(x)} \closedcycle;
          \addplot [very thick,penColor,domain=0:1, smooth] {-f(x)};
            \addplot [very thick,penColor,domain=1:5, smooth] {f(x)};
              \addplot [very thick,penColor,domain=5:8, smooth] {-f(x)};
                \addplot [very thick,penColor,domain=8:9, smooth] {f(x)};
            \node at (axis cs:0.5,1.2) {\large$A_1$};
              \node at (axis cs:3,1.2) {\large$A_2$};
              \node at (axis cs:6.5,1.2) {\large$A_3$};
              \node at (axis cs:8.5,1.2) {\large$A_4$};
