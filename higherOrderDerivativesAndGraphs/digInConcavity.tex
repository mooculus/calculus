...
\begin{image}
  \begin{tikzpicture}
    ...
    \draw [color=red,ultra thick, domain=2:2.1] plot({\x},{cot(193)*(\x-(2*cos(193)+4))+9-2*sin(193)});
    \draw [color=red,ultra thick, domain=2.42:2.77] plot({\x},{cot(225)*(\x-(2*cos(225)+4))+9-2*sin(225)});    
    \draw [color=red,ultra thick, domain=3.35:3.85] plot({\x},{cot(260)*(\x-(2*cos(260)+4))+9-2*sin(260)});
    \draw [color=red,ultra thick, domain=8.2:8.6] plot({\x},{-cot(280)*(\x-(2*cos(280)+8))+11+2*sin(280)});
    \draw [color=red,ultra thick, domain=9.29:9.61] plot({\x},{-cot(315)*(\x-(2*cos(315)+8))+11+2*sin(315)});
    \draw [color=red,ultra thick, domain=9.9:10] plot({\x},{-cot(347)*(\x-(2*cos(347)+8))+11+2*sin(347)});
