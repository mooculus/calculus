...
Using the Limit Laws we can prove that given two functions, both continuous on the same  interval, then their sum, difference, product, quotient (where defined) are also continuous on the same interval. 
