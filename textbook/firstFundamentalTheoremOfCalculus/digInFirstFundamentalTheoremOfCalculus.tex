...
\begin{center}
  \begin{tikzpicture}[scale=2,every node/.style={transform shape}]
    \node at (0,0) {
      $\color{blue!80!black!70!green}\ddx \color{green!70!black!70!blue}\int_a^x\color{purple!50!blue!90!black}f(t)\color{green!70!black!70!blue}\d t\color{black} = \color{purple!50!blue!90!black}f(x)$
      };
  \end{tikzpicture}
\end{center}
This could be read as:%%BADBAD I want this all in bold!
\begin{quote}\large The \textcolor{blue!80!black!70!green}{\textbf{rate}} that \textcolor{green!70!black!70!blue}{\textbf{accumulated area}} under a  \textcolor{purple!50!blue!90!black}{\textbf{curve}} grows is described identically by that  \color{purple!50!blue!90!black}{\textbf{curve}}.
\end{quote}
