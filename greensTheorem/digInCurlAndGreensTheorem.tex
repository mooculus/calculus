...
\begin{array}{|l|l|l|l|}\hline
  ...
  \begin{minipage}{1in}explicit curve\end{minipage}              & y = x^2                           & \dd[y]{x} = 2x              & \begin{minipage}{1in}slope of the tangent line\end{minipage} \\ \hline
  \begin{minipage}{1in}vector-valued function\end{minipage}    & \vec{p}(t) = \vector{t,t^2}       & \vec{p}'(t) = \vector{1,2t} & \begin{minipage}{1in}tangent vector\end{minipage} \\ \hline
  \begin{minipage}{1in}explicit surface\end{minipage}           & z = F(x,y) = x^2 -y               & \grad F(x,y)                & \begin{minipage}{1in}the vector that points in the initial direction of greatest increase\end{minipage} \\ \hline
      \begin{minipage}{1in}implicit curve (level curve)\end{minipage} & 0 = \underbrace{x^2 - y}_{G(x,y)} & \grad G(x,y)                & \begin{minipage}{1in}gradient vectors are orthogonal to level sets \end{minipage}\\ \hline
\end{array}
\]
