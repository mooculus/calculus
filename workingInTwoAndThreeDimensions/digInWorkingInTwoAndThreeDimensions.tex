...
circle).
 \begin{image}
      \begin{tikzpicture}
        \draw [penColor,very thick] (-11,0) circle [radius=1.5];
          
             
             \draw [penColor6,fill] (-12.7,2) -- (-9.5,2)--(-9,2.5) -- (-12.2,2.5)--(-12.7,2);
             \draw [penColor6,fill] (-4.5,1.25) -- (-1,1.25)--(-0.5,1.75) -- (-4,1.75)--(-4.5,1.25);
               \draw [penColor6,fill] (3.8,-1) -- (7.5,-1)--(8,-0.3) -- (4.2,-0.3)--(3.8,-1);
                \draw [penColor,very thick] (-2.5,0) circle [radius=1.5];
                \draw [penColor,very thick] (6,0) circle [radius=1.5];
           \draw[penColor,very thick] (6,-0.65) ellipse (1.4 and .2);
           \draw[dashed,penColor,very thick] (-11,0) ellipse (1.5 and .4);
           \draw[very thick,penColor] (-12.5,0) arc (180:360:1.5 and .4);
            \draw[dashed,penColor,very thick] (-2.5,0) ellipse (1.5 and .4);
             \draw[very thick,penColor] (-4,0) arc (180:360:1.5 and .4);
             \draw[dashed,penColor,very thick] (6,0) ellipse (1.5 and .4);
              \draw[very thick,penColor] (4.5,0) arc (180:360:1.5 and .4);
                \draw[penColor,very thick] (6,-0.65) ellipse (1.4 and .2);
                 \draw [penColor, fill] (-2.5,1.5) circle [radius=.1];
      \end{tikzpicture}
    \end{image}
