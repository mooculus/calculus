...
\begin{quote}\large\bfseries{The {\color{blue!80!black!70!green}rate} that {\color{green!70!black!70!blue}accumulated area} under a  {\color{purple!50!blue!90!black}curve} grows is described identically by that  {\color{purple!50!blue!90!black}curve}.}
\end{quote}
