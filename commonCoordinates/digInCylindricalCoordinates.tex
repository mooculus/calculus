...
\begin{definition}
  ...
  \begin{image}
	...
	zlabel={\scriptsize $z$},
        ...
        \addplot3[domain=0:1,samples y=0,gray] ({cos(45)},{sin(45)},2*x);
...
\begin{example}
  ...
  \begin{explanation}
    In this case
    \[
    R=\{(r,\theta,z):\text{$\answer[given]{0}\leq\theta\leq\answer[given]{\pi/2}$, $\answer[given]{0}\leq r\leq \answer[given]{2}$, $\answer[given]{0}\le z\le \sqrt{4-r^2}$}\}
    \]
    So our integral is
    \begin{align*}
...
\begin{example}
  ...
  \begin{explanation}
    ...
    \[
    R=\{(r,\theta,z):\text{$\answer[given]{0}\leq\theta\leq\answer[given]{2\pi}$, $\answer[given]{0}\leq r\leq \answer[given]{1}$, $-\sqrt{4-r^2}\le z\le \answer[given]{\sqrt{4-r^2}}$}\}
    \]
    Now write with me,
    \begin{align*}
