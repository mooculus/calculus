...
Before the sunset on an afternoon, how fast is the length of the shadow of a 72 ft tall tree changing when $ \theta$, the angle of elevation of the sun, is $\frac{\pi}{6}$? Assume that
