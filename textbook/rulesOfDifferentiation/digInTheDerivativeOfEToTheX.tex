...
\begin{document}
\begin{abstract}
  We derive the derivative of $e^x$.
\end{abstract}
\maketitle
...
\]
We will actually define the number $e$ by this property.
\begin{definition}\index{Euler's number}
Euler's number, which we denote $e$, is defined to be the number such that
\[
