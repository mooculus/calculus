...
Let's recall the idea of a global extrema.
\begin{definition}\hfil
	\begin{enumerate}
		\item A function $f$ has a \dfn{global maximum} at $x=a$, if $f(a)\geq
			  f(x)$ for every $x$ in the domain of the function.
		\item A function $f$ has a \dfn{global minimum} at $x=a$, if $f(a)\leq
			  f(x)$ for every $x$ in the domain of the function.
	\end{enumerate} 
	A \dfn{global extremum} is either a global maximum or a global minimum.
\end{definition}
