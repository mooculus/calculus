...
\begin{image}
  \begin{tikzpicture}
    \draw [penColor,very thick,domain=180:270] plot ({2*cos(\x)+4},{9-2*sin(\x)});
    \draw [penColor,very thick,domain=270:360] plot ({2*cos(\x)+8}, {2*sin(\x)+11});
    \draw [color=red,ultra thick, domain=1.97:2.13] plot({\x},{cot(193)*(\x-(2*cos(193)+4))+9-2*sin(193)});
    \draw [color=red,ultra thick, domain=2.32:2.87] plot({\x},{cot(225)*(\x-(2*cos(225)+4))+9-2*sin(225)});    
    \draw [color=red,ultra thick, domain=3.3:4.0] plot({\x},{cot(260)*(\x-(2*cos(260)+4))+9-2*sin(260)});
    \draw [color=red,ultra thick, domain=8.1:8.8] plot({\x},{-cot(280)*(\x-(2*cos(280)+8))+11+2*sin(280)});
    \draw [color=red,ultra thick, domain=9.23:9.7] plot({\x},{-cot(315)*(\x-(2*cos(315)+8))+11+2*sin(315)});
    \draw [color=red,ultra thick, domain=9.87:10.03] plot({\x},{-cot(347)*(\x-(2*cos(347)+8))+11+2*sin(347)});
