...
\begin{remark} 
With more work, an explicit formula may also be developed for this.  In fact,
...
, n \geq 1$ represent the same sequence.  We leave this to the curious reader as an exercise.
