...
Finding one of the functions isn't too challenging; since $y=\sin(8x)$, we can write $8x=\arcsin(y)$, so $x=\answer[given]{\frac{1}{8} \arcsin(y)}$.  Let's take a step back and see what $x$-values are actually given by this expression.

The range of $x=\arcsin(y)$ is the set of all $x$-values in the interval $\left[\answer[given]{-\frac{\pi}{2}} , \answer[given]{\frac{\pi}{2}} \right]$.  Hence, the range of $x=\frac{1}{8}\arcsin(y)$ is $\left[\answer[given]{-\frac{\pi}{16}} , \answer[given]{\frac{\pi}{16}} \right]$.

Thus, $x=\frac{1}{8} \arcsin(y)$ only describes the left half of the upper boundary.  We have the following picture:
		...
		%h
		\addplot [draw=penColor, fill = gray!50] plot coordinates {(.125,.841) (.27,.841) (.27,.641) (.125,.641) (.125,.841)};
