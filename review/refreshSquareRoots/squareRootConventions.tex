...
However, since the parabola \wordChoice{\choice{passes}\choice[correct]{does not pass}} the vertical line test, it \wordChoice{\choice{can}\choice[correct]{cannot}} be described by a single function of $y$.  In fact, if $a < 3$, any horizontal line $y=a$ will intersect the parabola twice, so we expect that $\answer{2}$ functions of $y$ will be needed to describe the parabola.
