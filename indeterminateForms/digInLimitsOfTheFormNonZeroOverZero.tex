...
\]
  \begin{selectAll}
    \choice[correct]{$\lim_{x\to -1} \frac{1}{(x+1)^2}$ does not exist}
    \choice{$\lim_{x\to -1} \frac{1}{(x+1)^2}$ does exist}
    \choice[correct]{$\lim_{x\to -1} \frac{1}{(x+1)^2}$ does not exist, because $f(x)$ is getting bigger and bigger, as $x$ is getting closer to $-1$ }
      \choice{$\lim_{x\to -1} \frac{1}{(x+1)^2}$ does not exist, because $\lim_{x\to -1^{-}}\frac{1}{(x+1)^2}\neq\lim_{x\to -1^{+}}\frac{1}{(x+1)^2}$}
       \choice{$\lim_{x\to -1} \frac{1}{(x+1)^2}=10^{8}$ }
         \choice{$\lim_{x\to -1} \frac{1}{(x+1)^2}$ does not exist, because $f(-1)$ is not defined.}
  \end{selectAll}
\end{question}
...
\[
 \frac{1}{(x+1)^2}
\]
will become arbitrarily large as  $x$ approaches $-1$, as we can see in the next graph.\\ 
