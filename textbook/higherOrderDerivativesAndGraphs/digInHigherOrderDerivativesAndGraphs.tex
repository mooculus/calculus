...
\begin{example}
  ...
  \begin{explanation} 
    ...
    \wordChoice[positive,negative,decreasing]{increasing} when $B$ is
    positive and \wordChoice[positive,negative,increasing]{decreasing}
    when $B$ is negative, we see
    \[
    A'=B.
    \]
    Since $B$ is increasing when $C$ is \wordChoice[negative,increasing,decreasing]{positive} and decreasing when
    $C$ is \wordChoice[positive,increasing,decreasing]{negative}, we see
    \[
    B'=C.
    \]
...
\end{image}
    Identify each curve above as a graph of $f$, $f'$, or $f''$.
      \begin{explanation} 
        ...
        \wordChoice[positive,negative,decreasing]{increasing} when $A$
        is positive and
        \wordChoice[positive,negative,increasing]{decreasing} when $A$
        is negative, we see
        \[
        B'=A.
        \]
        Since $A$ is increasing when $C$ is
        \wordChoice[negative,increasing,decreasing]{positive} and
        decreasing when $C$ is
        \wordChoice[positive,increasing,decreasing]{negative}, we see
        \[
        A'=C.
        \]
