...
\emph{Be careful with your notation for Squeeze Theorem}. There is no ``three-sided inequality'' with limit values in Squeeze Theorem. 
To use the Squeeze Theorem, you calculate the limits of the two functions on the outside of the inequality. If they're the same, then you know
the limit of the function on the inside. 
