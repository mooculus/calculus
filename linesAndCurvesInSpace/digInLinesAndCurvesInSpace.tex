...
cross product is only defined in dimension $3$ for this course, we
need $3$-dimensional vectors. If we consider the vector
$\vec{p}-\vec{q}$, we see by the definition of sine
\begin{image}
  \begin{tikzpicture}
    \begin{axis}[
        xmin=0,xmax=6,ymin=0,ymax=3,
