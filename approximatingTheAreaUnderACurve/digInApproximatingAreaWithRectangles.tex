...
compute the area under a curve, the  width of each rectangle is $\Delta x=\frac{b-a}{n}$. It is clear that $\Delta x=x_k-x_{k-1}$, for $k=1,..., n$. 
...
\begin{definition}
  ...
  rectangle. For  $k=1,..., n$, we denote a sample point as:
  \[
  x_k^*
  \]
  and the value
...
x_0 &= \answer[given]{0}\\
 ...
 ...\\
  x_n&=\answer[given]{4}.
\end{align*}
For a right Riemann sum, for $k=1,...,n$, we determine the sample points as follows:
\begin{align*}
