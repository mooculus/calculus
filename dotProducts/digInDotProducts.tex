...
\begin{theorem}
  ...
  \begin{explanation}
    ...
    \]
    Multiplying direction and magnitude (note the sign of the
...
the sum of two orthogonal vectors. Above we used vectors parallel to
...
\begin{example}
  ...
  described by the orthogonal decomposition of $\vec{g}$ in terms of
  $\vec{r}$. Find this orthogonal decomposition.
  \begin{explanation}
