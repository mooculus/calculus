...
\begin{question}
  ...
  \begin{selectAll}
    ...
    \choice[correct]{Relating people to their birthday.}
...
f(x) = \sqrt{x}.
\]
The domain is $0\le x<\infty$, which we prefer to write as $[0,\infty)$ in interval notation.
   The range is $(-\infty,\infty)$.  Here is a graph of $y=f(x)$.
