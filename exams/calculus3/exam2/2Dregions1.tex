...
\begin{exercise}
  ...
  \begin{center}
    \resizebox{.3\textwidth}{!}{\includegraphics{region2.png}}
    \resizebox{.3\textwidth}{!}{\includegraphics{region1.png}}
    \resizebox{.3\textwidth}{!}{\includegraphics{region6.png}} 
    \\
    \resizebox{.3\textwidth}{!}{\includegraphics{region5.png}} 
    \resizebox{.3\textwidth}{!}{\includegraphics{region4.png}} 
    \resizebox{.3\textwidth}{!}{\includegraphics{region3.png}}
  \end{center}
