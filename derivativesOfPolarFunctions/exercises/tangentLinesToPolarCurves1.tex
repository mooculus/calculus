...
Suppose te want to find tangent line to the curve when $\theta=\frac{\pi}{4}$. 
...
From the graph, it looks like the tangent line intersects the $x$-axis at $x=\answer[tolerance=.05]{ \frac{\sqrt{2}+1}{2} }$ and the $y$-axis at $y=\answer[tolerance=.05]{\frac{\sqrt{2}+1}{2}}$.
