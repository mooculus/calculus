...
\resizebox {5cm} {!} { 
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot [black,ultra thick,domain=0:360,smooth,samples=100] ({-((x/180)^(.5))*cos(x)+((x/180)^(.5))*sin(x)},{((x/180)^(.5))*sin(x)});
        \node[above right,black] at (axis cs: 0,-.3) {$\vec{p}(0)$};
%        \node[above right,black] at (axis cs: -1.3,0) {$\vec{p}(4)$};
        \node[above right,black] at (axis cs: {-((110/180)^(.5))*cos(110)+((110/180)^(.5))*sin(110)},{((110/180)^(.5))*sin(110)}) {$\vec{p}(2)$};
        \node[above left,black] at (axis cs: {-((45/180)^(.5))*cos(45)-.1+((45/180)^(.5))*sin(45)-.1},{((45/180)^(.5))*sin(45)-.1}) {$\vec{p}(1)$};
        \node[above right,black] at (axis cs: {-((215/180)^(.5))*cos(215)+.1+((215/180)^(.5))*sin(215)},{((215/180)^(.5))*sin(215)-.2}) {$\vec{p}(3)$};
        
        \addplot[color=black,fill=black,only marks,mark=*] coordinates{(-{((45/180)^(.5))*cos(45)+((45/180)^(.5))*sin(45)},{((45/180)^(.5))*sin(45)})};
        \addplot[color=black,fill=black,only marks,mark=*] coordinates{(-{((110/180)^(.5))*cos(110)+((110/180)^(.5))*sin(110)},{((110/180)^(.5))*sin(110)})};
        \addplot[color=black,fill=black,only marks,mark=*] coordinates{(-{((207/180)^(.5))*cos(207)+((207/180)^(.5))*sin(207)},{((207/180)^(.5))*sin(207)})};
%        \addplot[color=black,fill=black,only marks,mark=*] coordinates{(-{((270/180)^(.5))*cos(270)+((270/180)^(.5))*sin(270)},{((270/180)^(.5))*sin(270)})};
