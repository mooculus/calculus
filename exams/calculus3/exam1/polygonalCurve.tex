...
\begin{selectAll}
  ...
  \choice{If $\vec{v}$ and $\vec{w}$ are orthogonal, then $|\vec{v}+\vec{w}| = |\vec{v}-\vec{w}|$.}
  \choice[correct]{If $\vec{q}'(t) = \vector{e^t,\sin(t),3t^2}$ and $\vec{q}(0) = \vector{4,1,2}$, then $\vec{q}(t) = \vector{e^t+4,-\cos(t)+1,t^3+2}$.}
