...
to highlight their significance. Treat these three statements as the ``\textbf{continuity checklist}''. \emph{Using the definition of continuity to determine whether a function is continuous at a point or not means checking these three items}.
...
\begin{definition}
  ...
  \end{itemize}
  The \dfn{Intervals of Continuity} of $f$ are the (comma separated) list of largest intervals on which $f$ is continuous.
\end{definition}
