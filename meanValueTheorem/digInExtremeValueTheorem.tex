...
Does every function attain a global extremum on its domain? Select the correct answer.
 ...
 \choice{ All functions must attain both global minimum and global maximum on its domain.}
 \choice{ All functions  attain a global minimum on its domain.}
 \choice{ All functions  attain a global maximum on its domain.}
 \choice[correct] {Some functions have no global extremums on its domain.}
  \end{multipleChoice}
...
Does the function given by the graph above attain a global extremum on its domain? Select the correct answer.
 ...
 \choice {The function has no global extremum on its domain.}
  \end{multipleChoice}
Sometimes it is important to know whether a function attains a global extremum on its domain. If we are working on an finite closed interval, then we have the
following theorem.
