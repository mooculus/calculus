...
\begin{quote}
  ...
  \end{align*}
  Here $\mathrm{infect}(x)$ is the number of people infected by the
  disease on day $x$, and $\mathrm{suscept}(x)$ is the number of
  who are susceptible to the disease on day $x$.
\end{quote}
