...
\begin{multipleChoice}
\choice{Yes; $\Lim{(x,y)}{(0,0)}$ exists.}
\choice[correct]{Yes; $\Lim{(x,y)}{(0,0)}$ does not exist.}
\choice{No}
\end{multipleChoice}
...
\begin{multipleChoice}
\choice{Yes; $\Lim{(x,y)}{(0,0)}$ exists because $f(x,y)$ tends to a number along each path.}
\choice[correct]{Yes; $\Lim{(x,y)}{(0,0)}$ does not exist because $f(x,y)$ approaches a different value for different choices of $m$.}
\choice{No}
\end{multipleChoice}
