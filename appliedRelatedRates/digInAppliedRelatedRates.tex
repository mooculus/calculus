...
\item[\textbf{Evaluate.}] Evaluate
  each equation at the moment when we  know all desired values.
...
\begin{explanation}
  ...
  \]
  Now we'll \textbf{evaluate the equation at the moment when $r=20$}. 
  But, first, we have to compute $h$ at that moment. Since
  \[
 400 = 20^2 \cdot h, 
  \] it follows that $h=1$, when $r=20$. Now, we are ready to evaluate the equation.
