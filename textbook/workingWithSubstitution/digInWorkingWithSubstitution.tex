...
\[
\int x^3\sqrt{1-x^2}\d x = \int x^3 \answer[given]{\sqrt{g}} \left( \answer[given]{- \frac{1}{2x}} \right) \d g = \int -\frac{x^2 \answer[given]{\sqrt{g}}}{2}\d g.
\]
