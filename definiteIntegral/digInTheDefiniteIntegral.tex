...
\]
On the other hand, using the \textbf{definition of the definite integral}.
\[
...
\]
The last expression is clearly the signed area of the region between the x-axis and the curve $y=-x$.

Now we want to obtain the same result by computing the limit.
\begin{align*}
\int_0^{10}-x \d x&=-\lim_{n\to\infty}\sum_{k=1}^n x_k\Delta x\\
