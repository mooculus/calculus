...
\begin{hint}
We \textbf{introduce the variables}  $x$, the distance from  the foot of the ladder to the wall, and $y$, the distance from the top of the ladder to the floor. The given rate is $\frac{dx}{dt}=5$ ft/s, and the unknown rate is $\left[\frac{dy}{dt}\right]_{x=3}$. 
\end{hint}
