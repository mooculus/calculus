...
\begin{image}
  \begin{tikzpicture}
   ...
   \node at (1.5,11.5) [align=center] {\Large CIRCLE};
    ...
    %RECTANGLE
        \node at (1.5,5.75) [align=center] {\Large RECTANGLE};
	...
	%TRAPEZOID
	\node at (7.5,5.75) [align=center] {\Large TRAPEZOID};
	\draw [ultra thick] (6,3) -- (9,3) node[pos=0.5, below]{\LARGE a};
 	\draw [ultra thick] (9,3) -- (8.5,5) node[pos=0.5, right]{\LARGE b};
 	\draw[ultra thick]  (8.5,5) -- (7,5)node[pos=0.5, above]{\LARGE c};
	\draw [ultra thick] (7,5) -- (6,3)node[pos=0.5, left]{\LARGE d};
	\draw[dashed,ultra thick]  (7,3) -- (7,5) node[pos=0.5,right] {\LARGE h};
	
	\node at (7.5,1.5) [align=center] {\Large $P=a+b+c+d$\\ \Large $A=\frac{a+c}{2}h$};
...
\begin{tikzpicture}
%SPHERE
  \node at (1.5,2.5) [align=center] {\Large SPHERE};
  ...
  %CYLINDER
  \node at (7,2.5) [align=center] {\Large CYLINDER};
...
%BOX
  \node at (2.5,.5) [align=center] {\Large RECTANGULAR BOX};
...
\node at (2,-3) [align=center] {\large $V=lwh$\\ \large $SA=2lw+2wh+2lh$};  
  ...
  %CUBE
    \node at (8,.5) [align=center] {\Large CUBE};
...
\begin{tikzpicture}
%PYRAMID
  \node at (1.5,3.25) [align=center] {\Large PYRAMID};
...
%CONE 
  \node at (6.5,3.25) [align=center] {\Large CONE}; 
...
\begin{tikzpicture}
%Pyth Thm
  \node at (1.5,3.5) [align=center] {\Large Pythagorean Theorem}; 
...
\node at (7.25,3.5) [align=center] {\Large Distance Between\\ \Large Two Points}; 
\draw (5.5,.5) -- (9,.5);
\draw (6,0) -- (6,3);
...
ANGLE& 0 & $\pi / 6$ & $\pi / 4$ & $\pi / 3$ & $\pi / 2$ \\ \hline
$\sin(\theta)$ & 0 & $1 / 2$ & $1/\sqrt{2}$& $\sqrt{3}/2$ &1\\\hline  
$\cos(\theta)$ & 1 & $\sqrt{3}/2$ & $1/\sqrt{2}$& $1/2$ &0\\\hline  
$\tan(\theta)$ & 0 & $1/\sqrt{3}$ & 1& $\sqrt{3}$ & DNE \\\hline 
