...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{theorem}[Remainder Estimates for the Integral Test, Part 1]
...
%\begin{example}
%This value of $N$ found in the previous part is quite large.  Hopefully, you also noticed that it took technology quite some time to compute it.
%
%%%%%USE ERROR RESULTS%%%%%%
%\begin{explanation}
%
