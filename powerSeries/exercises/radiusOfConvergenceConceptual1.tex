...
%%%%number line%%%%	
	\draw[very thick,penColor] (axis cs:1,0) -- (axis cs:5,0);
	\draw[->,very thick,penColor2] (axis cs:-1.5,0) -- (axis cs:-5,0);
	\draw[->,very thick,penColor2] (axis cs:7.5,0) -- (axis cs:11,0);
	\draw[very thick,penColor4] (axis cs:-1.5,0) -- (axis cs:1,0);
	\draw[very thick,penColor4] (axis cs:5,0) -- (axis cs:7.5,0);

%Vertical LInes%%%
	\draw[thick,black,dashed] (axis cs:-1.5,-.25) -- (axis cs:-1.5,.25);
	\draw[thick,black,dashed] (axis cs:1,-.25) -- (axis cs:1,.25);
	\draw[thick,black,dashed] (axis cs:5,-.25) -- (axis cs:5,.25);
	\draw[thick,black,dashed] (axis cs:7.5,-.25) -- (axis cs:7.5,.25);

%%%%Center%%%%%	
	\node at (axis cs:3,-.05) [below, penColor] {$-1$};
	\draw[very thick,penColor] (axis cs:3,-.05) -- (axis cs:3,.05);
	
	
%%%%CONVERGENCE: arrows and minimum IOC
	\draw[->,thick,black!75] (axis cs:3.1,.1) -- (axis cs:5,.1);
	\draw[->,thick,black!75] (axis cs:2.9,.1) -- (axis cs:1,.1);
      	\node[black] at (axis cs:4.05,.17) {\small{$4$}};
        \node[black] at (axis cs:2.05,.17) {\small{$4$}};
       	%%%%%%brace and text
        \draw [penColor,thick,decoration={brace,mirror,raise=2em},decorate] 
        (axis cs:1,0) --
        (axis cs:5,0);
        \node[penColor] at (axis cs:3,-.41) {converges};
	%%%Endpoints
	\node at (axis cs:1,0) [scale=.5,shape=circle, draw=penColor4, fill=white] {};
	\node at (axis cs:.4,-.05) [below, black] {$-5$};
	\node at (axis cs:5,0) [scale=.5,shape=circle, fill=penColor, draw=penColor] {};
	\node at (axis cs:5.3,-.05) [below, black] {$3$};    
	
%%%%DIVERGENCE: arrows and maximum IOC
	\draw[->,thick,black!50] (axis cs:3.1,.05) -- (axis cs:7.5,.05);
	\draw[->,thick,black!50] (axis cs:2.9,.05) -- (axis cs:-1.5,.05);
      	\node[black] at (axis cs:6.35,.12) {\small{$5$}};
        \node[black] at (axis cs:-.25,.12) {\small{$5$}};
        %%%%%%brace and text
    	\draw [penColor2,thick,decoration={brace,mirror,raise=2em},decorate] 
        (axis cs:7.5,0) --
        (axis cs:11,0);
    	\node[penColor2] at (axis cs:9.5,-.4) {diverges};
    	\draw [penColor2,thick,decoration={brace,raise=2em},decorate] 
        (axis cs:-1.5,0) --
        (axis cs:-5,0);
	\node[penColor2] at (axis cs:-3.5,-.4) {diverges};
	%%%Endpoints
	\node at (axis cs:-1.5,0) [scale=.5,shape=circle, draw=penColor2, fill=penColor2] {};
	\node at (axis cs:-2.2,-.05) [below, black] {$-6$};
	\node at (axis cs:7.5,0) [scale=.5,shape=circle, fill=white, draw=penColor4] {};
	\node at (axis cs:8,-.05) [below, black] {$4$};
...
%%%%no man's land
    ...
    \node[penColor4] at (axis cs:3,.4) {may or may not converge};
\end{axis}
