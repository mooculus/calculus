...
in many of the concepts that follow in the rest of this chapter:
...
sure you remember where curves are (whether we are considering curves
in the domain or curves on the surface).
\end{remark}
%Add another example?%
...
One of the most common ways is to consider the graph of the
...
To begin, we present the scenario for functions $F:\R^2 \to \R$ since
...
Those points form our level set. Let's be explicit and state a
definition.
\begin{definition}
...
\begin{remark}
  ...
  hence no level curve nor contour curve associated to it.
\end{remark}
