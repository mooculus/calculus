...
\begin{exercise}
  ...
  \left(\answer{-2},\answer{-1}\right] \cup \left[\answer{0},\answer{3}\right)
      ...
      \begin{exercise}
        ...
        \begin{hint}
        On the interval $(-2,0]$, the graph of the function $g$ is a line. Therefore, on that interval, $g(x)=ax+b$, for some constants $a$ and $b$. 
        Similarly for $g(x)$ on the interval $(0,2]$.
        \end{hint}
        \[
        g(x) =
        \begin{cases}
