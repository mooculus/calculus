...
\begin{image}
  \begin{tikzpicture}
        \node at (0,0) {
          $s_n=\sum_{k=0}^n \left(\frac{1}{2}\right)^k=\underbrace{1+\frac{1}{2} +\left(\frac{1}{2}\right)^2 +\ldots + \left(\frac{1}{2}\right)^{n-1}}+\left(\frac{1}{2}\right)^n$,};
        \node at (.8,-.8) {This is $s_{n-1}$};
  \end{tikzpicture}
  \end{image}
